...
impl<R: Representation, const M: usize, C, X> Nsga2Builder<R, M, C, X> {
    ...
    /// The population size, at least 2; also the number of children per generation. Required.
    ...
    /// - [`Error::InvalidSetting`] for a population size below 2, no objectives, rates out of
