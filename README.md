...
- **Multi-objective:** NSGA-II with constrained dominance, O(N log N) non-dominated sorting for 2 objectives (ENS-BS for more), crowding distance; the number of objectives is checked at compile time; indicators: exact hypervolume, IGD, IGD+, GD, generalized spread
