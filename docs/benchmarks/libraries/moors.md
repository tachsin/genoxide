...
- **Output:** moors prints warnings with `println!`, so the adapter writes its JSON to a copy of stdout ([results_output](../../../benchmarks/adapters/moors/src/main.rs#L321)).
...
**Not run** ([main](../../../benchmarks/adapters/moors/src/main.rs#L701-L702)). moors has NSGA-II, NSGA-III, SPEA2 and SBX, but no polynomial mutation ([operators/mutation](https://github.com/andresliszt/moo-rs/tree/488063e679f74945dd3454c1982a93d62e5e1e1f/moors/src/operators/mutation)), and no MOEA/D or SMS-EMOA.
