...
- **Crossover:** one-point, two-point, k-point, uniform, and for real genomes SBX, blend (BLX-α), arithmetic
- **Mutation:** bit-flip, uniform, Gaussian, polynomial, swap (every mutation changes the genome)
